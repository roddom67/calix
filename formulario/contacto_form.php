...
<?php 
$title = " | Contacto ";
$description = "RD diseño web. Contátese con nosotros y realice su consulta para su próximo sito web.";
            ...
            <section>
                ...
                ?>
                    ...
                    <div class="Box">
                        ...
                        <form id="commentForm" method="post" action="contacto.php" class="jqtransform">
                            ...
                            <input type="hidden" name="token" id="token" value="<?=$newToken?>">
                            </fieldset>
                        </form>
                    </div>
				<?
                ...
                ?>
                    <div class="Box Respuesta">
                        <p>Gracias <?=$name?> por comunicarse con nosotros.</p>
