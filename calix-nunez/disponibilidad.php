			...
			<section class="disponibilidadArea">
 				<div class="container-fluid">
 					<div class="row">
  						...
  						<article class="col-12 col-md-8 plantas"><div class="accordion ui-accordion ui-widget ui-helper-reset hidden" id="planta_0" role="tablist"><h2 class="ui-accordion-header ui-corner-top ui-accordion-header-collapsed ui-corner-all ui-state-default ui-accordion-icons" role="tab" id="ui-id-1" aria-controls="ui-id-2" aria-selected="false" aria-expanded="false" tabindex="0"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span>Planta Baja / Cocheras<span>12 + 1 Cocheras</span><strong>Planta</strong></h2>
							<div style="display: none;" class="ui-accordion-content ui-corner-bottom ui-helper-reset ui-widget-content" id="ui-id-2" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="true"><ul class="row">
							...
							</div></div><!-- accordion --><div class="accordion ui-accordion ui-widget ui-helper-reset hidden" id="planta_4" role="tablist"><h2 class="ui-accordion-header ui-corner-top ui-accordion-header-collapsed ui-corner-all ui-state-default ui-accordion-icons" role="tab" id="ui-id-27" aria-controls="ui-id-28" aria-selected="false" aria-expanded="false" tabindex="0"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span>Depto 401 - Frente<span>2 Dormitorios / 2 Baños / Terraza 1 / Terraza 2</span><strong>Planta</strong></h2>
							<div style="display: none;" class="ui-accordion-content ui-corner-bottom ui-helper-reset ui-widget-content" id="ui-id-28" aria-labelledby="ui-id-27" role="tabpanel" aria-hidden="true"><ul class="row">
									<li class="col-8 col-md-6 superficieArea"><ul>
											<li>Superficie Cubierta 67 m2</li>
