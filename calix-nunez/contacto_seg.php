...
// Awkward but LOG must be flush left
    		...
    		if($handle = fopen('hacklog.log', 'a')) {
            	...
            	if (mail($to, $subject, $logging, $header)) {
            		echo "Envío de nota al administrador desde Narciso Underwear.";
            	}
...
';
			$message .= '<tr bgcolor="#1b1b1b"><td colspan="2" align="center"><h2 style="font-weight:bold; font-size: 22px; font-family: Tahoma,Geneva,sans-serif; color:#ffffff;">RD diseño web</h2><p style="font-weight:bold; font-size: 16px; font-family: Tahoma,Geneva,sans-serif; color:#ffffff;">Consulta desde la web</p></td></tr>';
			...
			//if($address) {$message .= "<tr><td width='100' height='25' valign='top' style='background: #eee; font-weight:bold; font-size: 14px; font-family: Tahoma,Geneva,sans-serif;'><strong>Dirección:</strong> </td><td>" . $address . "</td></tr>";}
			...
			//if($country) {$message .= "<tr><td width='100' height='25' valign='top' style='background: #eee; font-weight:bold; font-size: 14px; font-family: Tahoma,Geneva,sans-serif;'><strong>País:</strong> </td><td>" . $country . "</td></tr>";}
			//if($fone) {$message .= "<tr><td width='100' height='25' valign='top' style='background: #eee; font-weight:bold; font-size: 14px; font-family: Tahoma,Geneva,sans-serif;'><strong>Teléfono:</strong> </td><td>" . $fone . "</td></tr>";}
			...
			$message .= '<tr bgcolor="#1b1b1b"><td colspan="2" align="center" height="20"><h3 style="font-weight:bold; font-size: 11px; font-family: Tahoma,Geneva,sans-serif; color:#ffffff;"><em>RD diseño web</em> | +54 911 4087-3213 | Buenos Aires - Argentina</h3></td></tr>';
			...
			$message .= '<tr bgcolor="#1b1b1b"><td colspan="2" align="left" height="20"><h3 style="font-weight:bold; font-size: 10px; font-family: Tahoma,Geneva,sans-serif; color:#ffffff;">Este mail se ha generado en forma automática desde la web para enviar la consulta que ha realizado. Se envía copia para su verificación.</h3></td></tr>';
			$message .= "</table>";
			$message .= "</body></html>";
            ...
            if (preg_match($pattern, trim(strip_tags($_POST['email'])))) { 
                ...
                return "El email ingresado es inválido. Por favor ingréselo nuevamente!"; 
            } 
			...
			$subject = 'Consulta desde la web de RD diseño web.';
			
			$headers = "From: RD diseño web - Consulta desde la Web <info@rddiseno.com.ar> \r\n";
